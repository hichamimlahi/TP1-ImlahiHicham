...
![Bouton Nouveau Dépôt](./captures/Screenshot%202026-03-26%20202110.png)
*Clic sur le bouton pour créer un nouveau dépôt.*

![Configuration du Dépôt](./captures/Screenshot%202026-03-26%20202207.png)
...
![Initialisation Git](./captures/Screenshot%202026-03-26%20202340.png)
*Initialisation du dépôt Git local et création du dossier de captures.*

![Rédaction du README](./captures/Screenshot%202026-03-26%20202451.png)
*Création et édition de base du fichier README.md.*

![Ajout des fichiers](./captures/Screenshot%202026-03-26%20202803.png)
*Vérification du statut et ajout du fichier README.md à l'index.*

![Premier commit](./captures/Screenshot%202026-03-26%20202839.png)
*Exécution du tout premier commit sur le projet.*

![Liaison au dépôt distant](./captures/Screenshot%202026-03-26%20202936.png)
*Ajout du dépôt distant GitHub (origin).*

![Push de la branche main](./captures/Screenshot%202026-03-26%212023.png)
...
![Création de la branche dev](./captures/Screenshot%202026-03-26%20221244.png)
*Création et basculement sur la branche `dev`.*

![Création du fichier code](./captures/Screenshot%202026-03-26%20222725.png)
*Création d'un fichier source `hello.c` pour simuler le développement.*

![Ajout des modifications](./captures/Screenshot%202026-03-26%20223144.png)
*Ajout du nouveau fichier à l'index Git.*

![Commit sur dev](./captures/Screenshot%202026-03-26%20230726.png)
*Création d'un commit spécifique sur la branche `dev`.*

![Push de la branche dev](./captures/Screenshot%202026-03-26%20230924.png)
...
![Détection de la branche dev](./captures/Screenshot%202026-03-26%20231223.png)
*GitHub détecte le push récent et propose de créer une Pull Request.*

![Création de la Pull Request](./captures/Screenshot%202026-03-26%20231418.png)
*Ouverture et rédaction de la Pull Request.*

![Confirmation du Merge](./captures/Screenshot%202026-03-26%20231510.png)
*Validation de la fusion (Merge) dans la branche `main`.*

![Merge réussi](./captures/Screenshot%202026-03-26%20231529.png)
